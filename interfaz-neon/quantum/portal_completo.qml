...
Window {
    ...
    width: 1400
    height: 900
    title: "EL CAFÉ SIN LÍMITES - Sistema de Gestión v2.0 FINAL"
    color: "#050510"
    ...
    // CLIENTES CON EDITAR Y ELIMINAR
    Component {
        id: pantallaClientes
    ...
    Component {
        ...
        Row {
            ...
            function agregarAlCarrito(receta) {
                ...
                total += 25 // Precio promedio simplificado
            }
            ...
            function procesarVenta() {
                ...
                api.post("/ventas/", ventaData, function(exito, respuesta) {
                    if (exito) {
                        notificacion.mostrar("Venta procesada: #" + respuesta.id)
                        carrito = []
                        total = 0
                        cargarVentas()
                    } else {
